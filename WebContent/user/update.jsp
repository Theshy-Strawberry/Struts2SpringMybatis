...
<body>
   <div class="container" style="margin-top:30px;">
    	<fieldset>
		    <legend>User Update    <a id="index-btn" href="#" class="button button-rounded button-flat-action" style="margin-left:300px;margin-bottom:10px;"><i class="icon-home"></i>user list</a>
		    </legend>
		    	<form class="form-horizontal" action="${contextPath}/front/user_update.action">
				  <div class="control-group">
				    <label class="control-label" for="inputId">id</label>
				    <div class="controls">
				      <input type="text" id="inputId" name="user.id" value="${user.id}">
				    </div>
				  </div>
				  <div class="control-group">
				  ...
				  <div class="control-group">
				    ...
				    <div class="controls">
				      <input type="text" id="inputAge" name="user.age" value="${user.age}">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputJoinTime">joinTime</label>
				    <div class="controls">
				      <input type="text" id="inputJoinTime" name="user.joinTime" value="${user.joinTime}">
				    </div>
				  </div>
				  <div class="control-group">
				    <label class="control-label" for="inputBikou">bikou</label>
				    <div class="controls">
				      <input type="text" id="inputBikou" name="user.bikou" value="${user.bikou}">
				    </div>
				  </div>
				  <div class="control-group">
				    <div class="controls">
